...
# Краткое описание
**ProjectName** — небольшая 2D пазл-игра (логические головоломки). Игрок решает уровни, комбинируя различные элементы. Основные фишки: **генерация случайных уровней**, **редактор уровней** и **система подсказок**.
...
# Цель и задачи
**Цель проекта** — создать прототип пазл-игры, демонстрирующий базовую механику решения головоломо.
...
**Главные фишки:**  
- Процедурная генерация уровней с уровнем сложности  
